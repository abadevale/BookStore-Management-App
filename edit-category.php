<?php 
#php file to handle the edit crud operations in the admin panel 
session_start();
...
if (isset($_SESSION['user_id']) &&
	...
	#handling the no id set problem 
	if(!isset($_GET['id'])){
    ...
    #function to help in handling the categories
...
<head>
	...
	<title>Edit Category Option</title>
